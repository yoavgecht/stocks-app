...
const Input = (props) => {
    ...
    switch(props.elementType) {
        ...
        case ('date'): 
            inputElem = <DatePicker className={inputClasses.join(' ')} {...props.elementConfig} value={props.selectedDate} dateFormat="MM/DD/YYYY" isClearable={true}  onChange={props.changed}/>
            break;
